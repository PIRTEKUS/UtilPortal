...
def get_databases(conn_id):
    ...
    try:
        conn_str = f"DRIVER={{ODBC Driver 18 for SQL Server}};SERVER={conn.host};UID={conn.username};PWD={conn.password};Encrypt=no;TrustServerCertificate=no;PacketSize=1024;KeepAlive=30000;KeepAliveInterval=1000;"
